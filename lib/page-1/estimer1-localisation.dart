...
class estim1 extends StatefulWidget {
  const estim1({Key? key}) : super(key: key);
...
class _estim1State extends State<estim1> {
  List<String> itemsList =
  [
  'Ain borja','Ain chock','Ain diab','Ain sbaa','Anfa','Al fida','Al qods'
  ,'Autre secteur','Beausejour','Belveder','Ben msick','Bernoussi','Bourgone'
  ,'Californie','C.I.L','Centre ville','Florida','Hay hana','Hay hassani'
  ,'Hay inara','Hay mohammadi','Hay laymouna','Les princesses'
  ,'Lissasfa','Maarif','Mers sultan','Oasis','Oulfa','Roches noires'
  ,'Palmier','Polo','Quartier des hapitaux','Racine',
  'Sidi maarouf','Sidi moumen','Sidi othmane','Route azemmour',
  'Sbata','Val fleuri'];
  String? selectedITem = 'Autre secteur';
                        ...
                        child: SizedBox(
                          ...
                          height: 25 * fem,
                            child: DefaultTextStyle(
                              ...
                              child: const Text('Choose the neighborhood'),
                            ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      Navigator.push(context,MaterialPageRoute(builder: (context) => const estim2()));
                      },
                      child: Container(
                        // nextXej (1:100)
                        width: 150.42*fem,
